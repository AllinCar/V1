...
export const BottomNav: React.FC<BottomNavProps> = ({
  ...
  return (
    <div className="fixed bottom-0 inset-x-0 z-40 max-w-lg mx-auto pointer-events-none px-4">
      <div className="w-full bg-black/90 border border-white/10 rounded-[30px] px-2.5 pb-[calc(max(env(safe-area-inset-bottom),0.75rem))] pt-2 backdrop-blur-2xl shadow-[0_16px_50px_rgba(0,0,0,0.75)] flex items-center justify-between pointer-events-auto relative">
        {/* Left nav items */}
